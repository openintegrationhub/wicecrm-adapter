...
function processTrigger(msg, cfg) {
  ...
  async function getArticle(options) {
    try {
      ...
      if (!articleObj.rowid) return `No article with ROWID: ${msg.body.rowid} found...`;
  ...
  async function executeRequest() {
    try {
      ...
      const options = {
        uri: `https://oihwice.wice-net.de/plugin/wp_wice_client_api_backend/json?method=get_article&cookie=${cookie}&show_detailview=${msg.body.rowid}`, // eslint-disable-line
        headers: {
