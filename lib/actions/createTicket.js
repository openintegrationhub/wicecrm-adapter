...
async function processAction(msg, cfg) {
  try {
    ...
    if (!recordUid && !msg.data.organization) {
      console.error('No organization ID specified to add ticket to, aborting...');
   ...
   */
    ...
    const reply = await createTicket(transformedMsg, cfg);
