...
function processTrigger(msg, cfg) {
  ...
  async function getOrganization(options) {
    try {
      ...
      if (!organizationObj.rowid) return `No organization with ROWID: ${msg.body.rowid} found...`;
  ...
  async function executeRequest() {
    try {
      ...
      const options = {
        uri: `${cfg.url}/plugin/wp_wice_client_api_backend/json?method=get_company&cookie=${cookie}&pkey=${msg.body.rowid}`,
        headers: {
