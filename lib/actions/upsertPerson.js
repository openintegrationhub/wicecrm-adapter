...
async function processAction(msg, cfg) {
  try {
    ...
    const oihUid = (transformedMsg.meta !== undefined && transformedMsg.meta.oihUid !== undefined) ? transformedMsg.meta.oihUid : undefined;
    const recordUid = (transformedMsg !== undefined && transformedMsg.meta.recordUid !== undefined) ? transformedMsg.meta.recordUid : undefined;
    const applicationUid = (transformedMsg.meta !== undefined && transformedMsg.meta.applicationUid !== undefined) ? transformedMsg.meta.applicationUid : undefined;
